    ...
    <div className="p-8">
      ...
      <div className="flex justify-between mb-4">
        ...
        <div>
          <button
            ...
            className="bg-black text-white py-2 px-2 rounded hover:bg-red-600"
          >
            Add Venue
          </button>
        </div>
      ...
      {showForm && (
        <div className="fixed inset-0 bg-black bg-opacity-40 backdrop-blur-sm z-50 flex items-center justify-center">
          <div className="bg-white w-full max-w-lg mx-4 shadow-lg rounded-lg p-6 relative">
            <button
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold">Bookings for Your Venues</h2>
        <button
          ...
          <div className="w-full max-w-md bg-white shadow-lg rounded-lg p-6 relative">
            ...
            <div className="flex mb-4">
              <div className="flex flex-row mr-2 mb-2">
                ...
                <div className="w-1 h-6 bg-red-600 ml-1 mt-2"></div>
              </div>
              <h1
                className="text-3xl"
                style={{
      ...
      {filteredBookings.length === 0 ? (
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full border border-gray-300 text-left bg-white rounded shadow">
            <thead>
